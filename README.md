<div align="center">
  ...
  <h1>@omegion1npm/tempora-dolorum-beatae</h1>
  <p>ESLint plugin for Jest</p>
</div>

[![Actions Status](https://github.com/omegion1npm/tempora-dolorum-beatae/actions/workflows/nodejs.yml/badge.svg?branch=main)](https://github.com/omegion1npm/tempora-dolorum-beatae/actions)

## Installation

```bash
yarn add --dev eslint @omegion1npm/tempora-dolorum-beatae
```

**Note:** If you installed ESLint globally then you must also install
`@omegion1npm/tempora-dolorum-beatae` globally.
...
```js
const jest = require('@omegion1npm/tempora-dolorum-beatae');
...
💼
[Configurations](https://github.com/omegion1npm/tempora-dolorum-beatae/blob/main/README.md#shareable-configurations)
enabled in.\
⚠️ [Configurations](https://github.com/omegion1npm/tempora-dolorum-beatae/blob/main/README.md#shareable-configurations)
set to warn in.\
✅ Set in the `recommended`
[configuration](https://github.com/omegion1npm/tempora-dolorum-beatae/blob/main/README.md#shareable-configurations).\
🎨 Set in the `style` [configuration](https://github.com/omegion1npm/tempora-dolorum-beatae/blob/main/README.md#shareable-configurations).\
...
### @omegion1npm/tempora-dolorum-beatae-extended

This is a sister plugin to `@omegion1npm/tempora-dolorum-beatae` that provides support for the
matchers provided by
[`jest-extended`](https://github.com/jest-community/jest-extended).

<https://github.com/omegion1npm/tempora-dolorum-beatae-extended>

### @omegion1npm/tempora-dolorum-beatae-formatting

This project aims to provide formatting rules (auto-fixable where possible) to
ensure consistency and readability in jest test suites.

<https://github.com/dangreenisrael/@omegion1npm/tempora-dolorum-beatae-formatting>
